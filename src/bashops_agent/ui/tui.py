...
class BashopsApp(App):
    ...
    def process_query(self, query: str) -> None:
        ...
        try:
            ...
            self.call_from_thread(self.update_chat_log, f"[bold red]Execution Error:[/bold red]\n{error_output}")
        except Exception as e:
            self.call_from_thread(self.update_chat_log, f"[bold red]System Error:[/bold red] {str(e)}")
